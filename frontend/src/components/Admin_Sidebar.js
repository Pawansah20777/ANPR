...
import { FaCog, FaHome, FaHeart, FaList, FaSignOutAlt, FaUsers } from "react-icons/fa";
  ...
  return (
    <div className="sidebar open">
      ...
      <ul className="sidebar-menu">
        <li>
          <NavLink to="/adminlayout/dashboard" className={({ isActive }) => (isActive ? "active" : "")}>
            <FaHome className="icon" /> Dashboard
          </NavLink>
        </li>
        <li>
          <NavLink to="/adminlayout/admin_users" className={({ isActive }) => (isActive ? "active" : "")}>
            <FaUsers className="icon" /> Users
          </NavLink>
        </li>
        <li>
          <NavLink to="/adminlayout/adminlist" className={({ isActive }) => (isActive ? "active" : "")}>
